...
def minimax_basico(gato, raton, salida, turnos_a_futuro, es_turno_gato, filas, col, paredes):
    ...
    if turnos_a_futuro == 0: 
        ...
        # Aca uso la distancia manhattan.
    ...
    if es_turno_gato: 
        ...
        for paso in pasos_permitidos(gato, filas, col, paredes): 
            # Se llama a sí misma pasando el turno al ratón, esta es mi recursividad (False).
...
# Uso letras simples para pintar el tablero. Así mantengo el código súper limpio.
...
def iniciar_partida():
    ...
    while True: 
        ...
        # Uso input() para leer mi teclado, y agrego .lower() al final para que pase todo a minúscula automáticamente.
